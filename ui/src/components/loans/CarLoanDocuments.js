// src/pages/loan/CarLoanDocuments.jsx
...
export default function CarLoanDocuments() {
  ...
  const [docs, setDocs] = useState({
    govID:null, driverLicense:null, purchaseOrder:null,
    payStubs:null, insurance:null, creditConsent:null
  });
  ...
  return (
    <div className="container my-4">
      <h3 className="mb-3">Car Loan – Step 2: Documents & Amount</h3>
      ...
      <Form onSubmit={submit}>
        ...
        <Doc label="Driver’s licence"                  onChange={e=>file(e,"driverLicense")}  />
        <Doc label="Signed purchase order / Bill of sale" onChange={e=>file(e,"purchaseOrder")} />
        <Doc label="Recent pay stubs (2)"              onChange={e=>file(e,"payStubs")}       />
        <Doc label="Proof of insurance"                onChange={e=>file(e,"insurance")}      />
